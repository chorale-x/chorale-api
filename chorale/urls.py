...
from chorale_core.views import UserViewSet, CommentViewSet, GalleryList, SubscriberList, SubscriberDetail
...
urlpatterns = [
    ...
    url(r'^subscriber/$', SubscriberList.as_view()),
    url(r'^subscriber/(?P<pk>[a-zA-Z0-9]+)/$', SubscriberDetail.as_view())
]
