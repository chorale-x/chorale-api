"""
Django settings for chorale project.
...
SECRET_KEY = '3md45cd60)4tr9%qe%2wqah4-djnln&md8u^e0@xk4w8ye$+m@'
...
WSGI_APPLICATION = 'chorale.wsgi.application'
